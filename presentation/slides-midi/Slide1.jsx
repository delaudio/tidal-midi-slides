    ...
    return (
      <Slide transition={['zoom']} bgColor="primary">
        <Heading size={1} fit caps lineHeight={1} textColor="secondary" margin="0 0 20px 0">
          Sequence with TidalCycles
        </Heading>
        <Text size={0.4} margin="20px 0 0 0" padding="0 0 100px 0">
          Live coding hardware with midi and cv/gate
        </Text>
        <Text size={0.3} margin="50px 0 0 0" top="-40px">
          Federico Del Gaudio
        </Text>
      </Slide>
    );
