...
export default class Slide4 extends Component {
  ...
  render() {
    return (
      <Slide>
        <Heading caps textColor="secondary" margin="0 0 20px 0">
          TidalCycles
        </Heading>
        <List>
          <ListItem>
            Live coding environment designed for musical improvisation and composition embedded in <span style={{color: 'red'}}>Haskell language</span>
          </ListItem>
          <ListItem>
